        ...
        services : [
            ...
            /*
                    ,{
                        ...
                        activation : "periodic", //"event"
                        activation_period : 1000,
                        activation_time : "now" //"on_event"
...
var GTTS_coordinates_handler = {
    ...
    process_coordinates : function(coords)
    {
        ...
        //    tracked_values.document_relative_filtered_x,
        //    tracked_values.document_relative_filtered_y
        ...
        {
            //this.sendClientResponse(tracked_values);
            //this.sendClientResponse_toLogService(tracked_values);
...
var GTTS_webSocket = {
    ...
    send_client_response_to_service(response, service_name)
    {
...
GTTS_coordinates_handler.sendClientResponse_toLogService = function(json_response)
{
    if(GTTS_StateMachine.get_current_state_name()=="session_is_open")
    {
        //GTTS_webSocket.send_client_response_to_service(json_response,"Log_Service");
    }
}
...
GTTS_window_visibility.set_window_visibility_checks=function() {
    ...
    function onchange (evt) {
        ...
        if (evt.type in evtMap)
          /*document.body.className*/ result = evtMap[evt.type];
        else
          /*document.body.className*/ result = this[hidden] ? "hidden" : "visible";

        //CUSTOM
        //console.log(result);
        if(result == "hidden") GTTS_window_visibility.on_window_hidden();//Mir_GGTS_on_window_hidden();
        if(result == "visible") GTTS_window_visibility.on_window_visible();//Mir_GGTS_on_window_visible();
...
/*
var GTTS_Init_System = function()
{
    GTTS_webSocket.flags.system_initialized = true;
}
*/
GTTS_Client.start = function(opts)
{
    ...
    /*
    if(!GTTS_webSocket.flags.system_initialized)
    {
        GTTS_Init_System();
    }
    */
