 ...
 * It features two buttons that can be clicked by looking at the button and pressing the Direct Click key/EyeX button.
 *
...
void OnDraw(HDC hdc)
{
	...
	const TCHAR* message = _T("Click the buttons with your eyes! Look at a button and use the Direct Click key/EyeX button ")
		_T("(usually right Ctrl). Space works too as long as this window has the input focus.");
